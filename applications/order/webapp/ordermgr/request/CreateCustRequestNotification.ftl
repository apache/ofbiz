...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <a href="${StringUtil.wrapString(baseUrl?if_exists)}/myportal/control/showPortletMainDecorator?portalPortletId=ViewCustRequest&amp;id=${custRequest.custRequestId}">here....</a>
        <br /><br />
        Regards.
        <br /><br />
