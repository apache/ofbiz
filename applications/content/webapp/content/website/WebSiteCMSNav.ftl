...
<script language="javascript" src="<@ofbizContentUrl>/images/jquery/plugins/elrteEditor/i18n/elrte.${language!"en"}.js</@ofbizContentUrl>" type="text/javascript"></script><#rt/>
</#if>
