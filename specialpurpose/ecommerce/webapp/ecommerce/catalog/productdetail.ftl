          ...
          <#if inStock>
            ...
            <#if product.productTypeId?if_exists == "ASSET_USAGE">
              <div class="inline">
                ...
                <label>End Date(yyyy-mm-dd)</label><@htmlTemplate.renderDateTimeField name="reservEnd" className="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" value="" size="25" maxlength="30" id="reservEnd1" dateType="date" shortDateInput=true timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
              </div>
              <div>
