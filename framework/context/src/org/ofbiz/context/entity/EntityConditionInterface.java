 ...
 *
 */
public interface EntityConditionInterface extends Reusable {

    //public String makeWhereString(ModelEntityInterface modelEntity, List<EntityConditionParam> entityConditionParams, DatasourceInfo datasourceInfo);

    public void checkCondition(ModelEntityInterface modelEntity) throws GenericEntityException;
    ...
    public EntityConditionInterface freeze();
}
